...
public class OrderAppService : IOrderAppService
{
    ...
    public async Task<string?> GetItemInstructionAsync(int id)
    {
        return await _orderAppRepository.GetItemInstructionAsync(id);
    }

    public async Task<bool> SaveItemInstructionAsync(int ItemDetailId, string instruction)
    {
        return await _orderAppRepository.SaveItemInstructionAsync(ItemDetailId, instruction);
    }
